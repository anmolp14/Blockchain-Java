...
public class ScriptTest {
    ...
    private static final String faucetAddress = "mmuzciNRnXJHtAbBaPwcYTFTBp25espzUe";
    ...
    public void downloadBlockchain() {
        ...
        kit.startAsync();
        LOGGER.info("Starting to sync blockchain 2");
        kit.awaitRunning();
        LOGGER.info("Starting to sync blockchain 3");
